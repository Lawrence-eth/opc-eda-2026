...
| **CURRENT (2026-07-08, integrated v17)**: wrapper + rebuilt binary | **1.696014, 100/100, 0 position diffs** vs `results/integrated_v17.json`; avg 0.231s/case incl. spawn (max 0.512s); fuzz 400/400 feasible (avg 0.230s, p95 0.431s, max 0.536s) |
...
|---|---|---|
| Field median runtime < 0.8s (floor not reached) | Unlikely: every executable submission pays spawn per case; ML entries pay torch/model-load per case (seconds) | Even at RF=1 exactly, 1.696 with 100/100 is a sound entry |
...
# REQUIRED: Total Score 1.6960, Feasible 100, and 0 position diffs vs results/integrated_v17.json
