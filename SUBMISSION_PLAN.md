...
| **CURRENT (2026-07-08, integrated v20)**: wrapper + rebuilt binary | **1.656802, 100/100, 0 position diffs** vs `results/integrated_v20.json`; avg 0.239s/case incl. spawn (max 0.640s); fuzz 400/400 feasible (avg 0.233s, p95 0.444s, max 0.604s) |
...
# REQUIRED: Total Score 1.6568, Feasible 100, and 0 position diffs vs results/integrated_v20.json
