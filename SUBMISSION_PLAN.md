...
| **CURRENT (2026-07-09, integrated v28)**: wrapper + rebuilt binary | **1.619032, 100/100, 0 position diffs** vs `results/integrated_v28.json`; avg 0.218s/case incl. spawn (p95 0.397s, max 0.623s); fuzz 400/400 feasible (avg 0.213s, p95 0.367s, max 0.511s) |
...
|---|---|---|
| Field median runtime < 0.8s (floor not reached) | Unlikely: every executable submission pays spawn per case; ML entries pay torch/model-load per case (seconds) | Even at RF=1 exactly, 1.6190 with 100/100 is a sound entry |
...
# REQUIRED: Total Score 1.6190, Feasible 100, and 0 position diffs vs results/integrated_v28.json
