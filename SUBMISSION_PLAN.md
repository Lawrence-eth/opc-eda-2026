...
| **CURRENT (2026-07-08, integrated v19)**: wrapper + rebuilt binary | **1.665114, 100/100, 0 position diffs** vs `results/integrated_v19.json`; avg 0.282s/case incl. spawn (max 0.944s, host-slow sample); fuzz 400/400 feasible (avg 0.235s, p95 0.463s, max 0.606s) |
...
|---|---|---|
| Field median runtime < 0.8s (floor not reached) | Unlikely: every executable submission pays spawn per case; ML entries pay torch/model-load per case (seconds) | Even at RF=1 exactly, 1.665 with 100/100 is a sound entry |
...
# REQUIRED: Total Score 1.6651, Feasible 100, and 0 position diffs vs results/integrated_v19.json
