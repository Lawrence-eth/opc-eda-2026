...
| **CURRENT (2026-07-08, integrated v18)**: wrapper + rebuilt binary | **1.684492, 100/100, 0 position diffs** vs `results/integrated_v18.json`; avg 0.235s/case incl. spawn (max 0.593s); fuzz 400/400 feasible (avg 0.232s, p95 0.443s, max 0.603s) |
...
|---|---|---|
| Field median runtime < 0.8s (floor not reached) | Unlikely: every executable submission pays spawn per case; ML entries pay torch/model-load per case (seconds) | Even at RF=1 exactly, 1.684 with 100/100 is a sound entry |
...
# REQUIRED: Total Score 1.6845, Feasible 100, and 0 position diffs vs results/integrated_v18.json
