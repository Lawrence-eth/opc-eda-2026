...
| **CURRENT (2026-07-09, integrated v27)**: wrapper + rebuilt binary | **1.620687, 100/100, 0 position diffs** vs `results/integrated_v27.json`; avg 0.217s/case incl. spawn (p95 0.393s, max 0.613s); fuzz 400/400 feasible (avg 0.212s, p95 0.373s, max 0.527s) |
...
|---|---|---|
| Field median runtime < 0.8s (floor not reached) | Unlikely: every executable submission pays spawn per case; ML entries pay torch/model-load per case (seconds) | Even at RF=1 exactly, 1.6207 with 100/100 is a sound entry |
...
# REQUIRED: Total Score 1.6207, Feasible 100, and 0 position diffs vs results/integrated_v27.json
