...
DEFAULT_RESULT = ROOT / "results" / "integrated_v10.json"
...
def main() -> None:
    ...
    parser.add_argument("--max-score", type=float, default=1.81, help="Maximum allowed published score (current integrated = 1.8074)")
