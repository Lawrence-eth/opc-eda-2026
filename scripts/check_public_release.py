...
DEFAULT_RESULT = ROOT / "results" / "integrated_v23.json"
...
def main() -> None:
    ...
    parser.add_argument("--max-score", type=float, default=1.64, help="Maximum allowed published score (current integrated = 1.6385)")
