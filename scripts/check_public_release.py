...
DEFAULT_RESULT = ROOT / "results" / "integrated_v17.json"
...
def main() -> None:
    ...
    parser.add_argument("--max-score", type=float, default=1.70, help="Maximum allowed published score (current integrated = 1.6960)")
