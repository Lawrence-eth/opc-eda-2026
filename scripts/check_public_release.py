...
DEFAULT_RESULT = ROOT / "results" / "integrated_v16.json"
...
def main() -> None:
    ...
    parser.add_argument("--max-score", type=float, default=1.71, help="Maximum allowed published score (current integrated = 1.7027)")
