...
DEFAULT_RESULT = ROOT / "results" / "integrated_v20.json"
...
def main() -> None:
    ...
    parser.add_argument("--max-score", type=float, default=1.66, help="Maximum allowed published score (current integrated = 1.6568)")
