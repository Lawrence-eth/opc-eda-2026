...
> `results/integrated_v17.json` (current) and `results/v9_locked.json`
...
|---|---|---|
| Official score (RF=1) | 2.7182 | **1.6960** (-38%) |
| Feasible | 100/100 | **100/100** |
| Runtime | 0.18s avg | **0.239s avg** (same speed class) |
| Runtime-adjusted @ median 1s | 2.110 | **1.322** (-37%) |
| Packaged binary, official command | — | 1.696014, 0 position diffs, 0.231s incl. spawn |
...
- **Remaining gap:** weighted heavy-case hpwl_gap 0.645 / area_gap 0.162 —
...
# -> Total Score: 1.6960, Feasible: 100
