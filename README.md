...
39% better raw quality, and the kept v20 tail improves v19 at medians
{1,2,3}s.
...
results/                     # Curated result artifacts (integrated_v20.json = current)
...
.venv/bin/python scripts/check_public_release.py    # PASS (defaults: results/integrated_v20.json, --max-score 1.66)
```
