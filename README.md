...
than v9. v26 backfills short obstacle-edge rows, and v27 relaxes the active
slab aspect guard in two established feature pockets without adding portfolio
candidates.
...
tests/                       # Regression + unit tests (55)
results/                     # Curated result artifacts (integrated_v27.json = current)
...
.venv/bin/python scripts/check_public_release.py    # PASS (defaults: results/integrated_v27.json, --max-score 1.635)
```
