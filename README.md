...
39% better raw quality, and the kept v22 cluster-lane ordering improves v21 at medians
{1,2,3}s.
...
results/                     # Curated result artifacts (integrated_v22.json = current)
...
.venv/bin/python scripts/check_public_release.py    # PASS (defaults: results/integrated_v22.json, --max-score 1.65)
```
